...
int main()
{
    { // 测试单个数字 0-9
        ...
        static_assert(mcs::abnf::uri::dec_octet(valid1));
        static_assert(mcs::abnf::uri::dec_octet(valid2));
        static_assert(mcs::abnf::uri::dec_octet(valid3));
    }
    ...
    { // 测试两位数 10-99
        ...
        static_assert(mcs::abnf::uri::dec_octet(valid1));
        static_assert(mcs::abnf::uri::dec_octet(valid2));
        static_assert(!mcs::abnf::uri::dec_octet(invalid1));
    }
    ...
    { // 测试200-255
        ...
        static_assert(mcs::abnf::uri::dec_octet(valid2));
        static_assert(!mcs::abnf::uri::dec_octet(invalid1));
        static_assert(!mcs::abnf::uri::dec_octet(invalid2));
    }
    ...
    { // 测试250-255
        ...
        static_assert(mcs::abnf::uri::dec_octet(valid2));
        static_assert(!mcs::abnf::uri::dec_octet(invalid1));
        static_assert(mcs::abnf::uri::dec_octet(invalid2)); // 245是有效值
    }

    { // 测试无效长度
        constexpr std::array<mcs::abnf::OCTET, 0> invalid0{};
        static constexpr mcs::abnf::OCTET invalid4[] = {'1', '2', '3', '4'};
        static_assert(!mcs::abnf::uri::dec_octet(invalid0));
        static_assert(!mcs::abnf::uri::dec_octet(invalid4));
    }
    ...
    { // 测试边界值
        ...
        static_assert(mcs::abnf::uri::dec_octet(max));
        static_assert(mcs::abnf::uri::dec_octet(min));
        static_assert(!mcs::abnf::uri::dec_octet(overflow));
    }
    std::cout << "main done\n";
    return 0;
}
