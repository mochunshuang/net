...
namespace draft::__detail
{
    ...
    struct product_type_base<::std::index_sequence<I...>, T...>
        : ::draft::__detail::product_type_element<I, T>...
    {
    ...
    template <typename... T>
    struct product_type
        : ::draft::__detail::product_type_base<::std::index_sequence_for<T...>, T...>
    {

        template <typename Self, typename Fun, ::std::size_t... I> // NOLINTNEXTLINE
        constexpr auto apply_elements(
            this Self &&self, ::std::index_sequence<I...> /*unused*/,
            ...
            -> decltype(auto)
        {
            return ::std::forward<Fun>(fun)(
                ::std::forward_like<Self>(std::forward<Self>(self).template get<I>())...);
        }
    ...
    constexpr bool // NOLINTNEXTLINE
        is_product_type_v<::draft::__detail::product_type<U...>> = true;
...
{
    template <typename... T>
    struct tuple_size<::draft::__detail::product_type<T...>> // NOLINT
        : ::std::integral_constant<std::size_t, sizeof...(T)>
    {
    };

    template <::std::size_t I, typename... T>
    struct tuple_element<I, ::draft::__detail::product_type<T...>> // NOLINT
    {
        using type = ::std::decay_t<
            decltype(::std::declval<::draft::__detail::product_type<T...>>()
                         .template get<I>())>;
    };
}; // namespace std
...
namespace std
{
    // for std::get<>
    template <std::size_t I, typename T>
        requires ::draft::__detail::is_product_type<::std::remove_cvref_t<T>>
